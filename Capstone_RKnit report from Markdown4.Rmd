...
htmltools::img(src = knitr::image_uri("D:/Ajoke/Google Data Analytics/Course 8_Capstone Project/Cyclistic_Data/Summarized_data/Cyclistic.png"), 
               alt = 'logo', 
...
```{r files, echo=FALSE}
setwd("D:/Ajoke/Google Data Analytics/Course 8_Capstone Project/Cyclistic_Data/Summarized_data")
...
knitr::include_graphics("D:/Ajoke/Google Data Analytics/Course 8_Capstone Project/Cyclistic_Data/Summarized_data/Screengrab.PNG")
...
knitr::include_graphics("D:/Ajoke/Google Data Analytics/Course 8_Capstone Project/Cyclistic_Data/Summarized_data/Stn13022Chicago.PNG")
...
##Specify full image path to avoid errors
knitr::include_graphics("D:/Ajoke/Google Data Analytics/Course 8_Capstone Project/Cyclistic_Data/Summarized_data/Kingsbury.PNG")
...
The analysis showed that docked bikes were only used by casual riders with an annual peak in June (early summer). Casual riders used the classic and eletric bikes at lower rates than annual members in January, February, March, November, and December). Casual riders rode the bikes for longer than annual members between May and October 2021. These months also have longer daylight hours. This suggests that a lot of casual riders use the bikes in months with peak tourism in the Chicago area. 
...
The weekly charts showed more travel on Saturdays and Sundays among casual riders. Annual members used the bikes more than casual riders during the week. These casual riders also rode the bikes for longer on weekends compared to the annaul members. Annual members rode the bikes for nearly the same period of time throughout the week. This further suggests that most casual riders use the bikes for tourism related or leisure rides. 
\
\
...
**NOTE:**
*This is NOT an official document related to any company. It is the output for the Google Data Analytics Capstone project submitted by Dr Ajoke Onojeghuo. The data has been made available under [license](https://ride.divvybikes.com/data-license-agreement) from Motivate International Inc.*